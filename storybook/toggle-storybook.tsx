...
import type { StorybookUIRoot as StorybookUIRootType } from "./storybook"
 ...
 */
export const ToggleStorybook = (props: ToggleStorybookProps) => {
  const [showStorybook, setShowStorybook] = useState(false)
  const [StorybookUIRoot, setStorybookUIRoot] = useState<typeof StorybookUIRootType | null>(null)
